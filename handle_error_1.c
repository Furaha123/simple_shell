...
/**
 * strcat_cd - function that concatenates the messages for cd error
...
/**
 * error_get_cd - error messages for cd command in get_cd
 * @datash: data relevant (directories)
 * Return: Error messages
 */
...
/**
 * error_not_found - generic error messages for commands not found
